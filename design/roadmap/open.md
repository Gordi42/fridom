...
3. **Advection-kernel throughput — WENO selected-input IMPLEMENTED
   2026-07-16 on `perf/weno-selected-input`.** The stencil-lowering
   study
   ...
   **Still open:** re-run the Oceananigans comparison suite (projected
   weno5 edge ~1.8×); multi-host (`srun -n P`) confirmation of the
