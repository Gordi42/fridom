...
| 5 | Validation gate (1.7) | Hand-rolled advection/diffusion PDE single + multi device, `../../specs/grid/05_validation.md` checks, coverage/ruff gates, old-vs-new benchmark table, merge to `dev` |
