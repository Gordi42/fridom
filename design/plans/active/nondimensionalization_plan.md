...
advection=None, modules_extra=(), name=None, **kwargs)` — scaling
...
- **B5 presets**: `nh.Model(*, grid, core, time_stepper,
  ...
  (opt-in: None = NO stratification), advection=None,
  modules_extra=(), name=None)`; `hy.Model(..., core,
  stratification, free_surface REQUIRED (None refused taught),
  scaling=None→Dimensional(), coriolis=None, advection=None,
