...
([`../grid/00_overview.md`](../grid/00_overview.md))
...
2. **`Convolution`** is *defined* as a composite (grid-redesign
   [section 3.12](../grid/02_rules.md#312-dealiasing)):
...
grid-redesign [section 2.4](../grid/01_concepts.md#24-field)),
...
[4.6](../grid/03_api_sketches.md#46-operator-eigenvalues-for-exact-spectral-solvers))
