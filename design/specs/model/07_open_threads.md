...
4. **D4 — composition/lifecycle**: **resolved 2026-07-08** (full
   ...
   (`../grid/classes/grid.md`, `../grid/02_rules.md` §3.4 — the last
   ...
   fingerprint/verify path (`../grid/classes/grid.md`, `../grid/02_rules.md`
...
11. **Phase-1 reconciliation: resolved 2026-07-08** — the
   ...
   - **Per-step sync amplification**: the model half is
     **discharged** — literal "tendencies are operators" is rejected
     ...
     sync-policy-neutral, so `../grid/classes/decomposition.md`'s "decide
     ...
     [`../grid/classes/fields.md`](../grid/classes/fields.md) follow-up.
   ...
   - **Metadata-in-treedef**: resolved — the annotation-exempt
     ...
     [`../grid/classes/fields.md`](../grid/classes/fields.md); model.md's
...
7. **Grid-notes amendments owed**: the dispatch-merge call site
   ...
   phrasing in [`../grid/classes/fields.md`](../grid/classes/fields.md)
   ...
   applied to `../grid/classes/fields.md` on 2026-07-07**, and the
