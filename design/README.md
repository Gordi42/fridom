...
| [`immersed_graded_advection_plan.md`](plans/done/immersed_graded_advection_plan.md) | active | Immersed graded advection: shipped 2026-07-18 (mask-keyed graded ladder); retains the distributed-bounded-axis note and owner-gated GPU perf levers. |
| [`mapped_immersed_composition_plan.md`](plans/done/mapped_immersed_composition_plan.md) | active | Mapped+immersed composition: M0–M5 shipped 2026-07-18/19; the one open leaf (sw2 mapped+immersed) is deferred with its trigger in `roadmap/deferred.md`. |
| [`partial_bottom_phyd_plan.md`](plans/done/partial_bottom_phyd_plan.md) | active | Partial-bottom hydrostatic pressure: flat/stretched correction shipped 2026-07-19; PB-D3 (terrain-chart moment quadrature) deferred. |
