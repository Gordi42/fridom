...
| [`coriolis_energy_correction.md`](plans/active/coriolis_energy_correction.md) | draft | Exactly-conserving Coriolis: the optional correction term (keeps `L`, eigenmodes valid) and the full nonlinear module (simpler, but no `L`). |
