...
| [`adiabatic_ramping.md`](plans/active/adiabatic_ramping.md) | idea | Generalized adiabatic ramping — the base transform; OptimalBalance becomes a subclass. Not scheduled. |
| [`coriolis_energy_correction.md`](plans/active/coriolis_energy_correction.md) | draft | Optional nonlinear Coriolis energy-correction term: closes the O(Ro) energy error without touching the linear operator (eigenmodes stay valid). |
