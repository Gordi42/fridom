...
class ModelSettings(ModelSettingsBase):
    ...
    Attributes:
        ...
        Lx (dtype)             : Domain size in x-direction.
        Ly (dtype)             : Domain size in y-direction.
        Lz (dtype)             : Domain size in z-direction.
        ...
        klim (dtype)           : Maximum wave number for which the
                                 Nonlinear Term is computed.
        ...
        enable_sp_damp (bool)   : Enable spectral damping.
