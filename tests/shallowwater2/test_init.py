"""Test the imports of fridom/shallowwater2 and its modules package."""
import pytest

import fridom.shallowwater2
import fridom.shallowwater2.modules
...
all_imports = [
    ...
    for module in (fridom.shallowwater2, fridom.shallowwater2.modules)
