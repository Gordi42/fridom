...
the BC-row API gap in [`phase1_findings.md`](phase1_findings.md);
the task-1.8 periodicity-gated validity claims in the
[decomposition contract](classes/decomposition.md) (whose recorded
...
4. **Model-layer tie-in**: inhomogeneous BCs
   ...
   open question in [`classes/spaces.md`](classes/spaces.md)
