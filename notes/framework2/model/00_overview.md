...
designed in the sibling note set [`../`](../00_overview.md) and is
...
- **`State` is a `VectorField`** — named `ScalarField` components on
  ...
  ([`../classes/fields.md`](../classes/fields.md), State contract).
- **The assembly handshake is normative**
  ([`../classes/grid.md`](../classes/grid.md), grid lifecycle):
...
- **Modules carry dispatch-override dicts**
  ...
  by the grid notes ([`../02_rules.md`](../02_rules.md) section
...
- **The grid is fully static** (no dynamic pytree leaves);
  ...
  ([`../01_concepts.md`](../01_concepts.md) sections 2.6, 2.7).
...
in [`../classes/fields.md`](../classes/fields.md) says physics
