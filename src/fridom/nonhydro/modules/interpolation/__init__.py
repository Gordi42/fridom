...
base_path = "fridom.nonhydro.modules.interpolation"
all_imports_by_origin = {
    f"{base_path}.interpolation_module": ["InterpolationModule"],
    f"{base_path}.linear_interpolation": ["LinearInterpolation"],
    f"{base_path}.polynomial_interpolation": ["PolynomialInterpolation"],
}
