...
class Identity(Operator):
    ...
    def eigenvalues(
        ...
        """
        from fridom.spatial.operators.symbol import (  # noqa: PLC0415
            Symbol,
        )
        from fridom.spatial.spaces.tensor_product import (  # noqa: PLC0415
            TensorProductSpace,
        )
    ...
    def _apply_factor(self, f: FieldLike, axis: str) -> FieldLike:
        ...
        for op in reversed(self._factors):
            if isinstance(op, Dispatched):
                from fridom.spatial.operators.registry import (  # noqa: PLC0415
                    DispatchError,
                )
                raise DispatchError(
...
def _sync_node() -> Operator:
    ...
    from fridom.spatial.operators.movement import (  # noqa: PLC0415 — import cycle seam
        Sync,
    )
    return Sync()
