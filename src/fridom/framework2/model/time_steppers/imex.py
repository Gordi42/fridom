...
from fridom.framework2.model.schedule import TendencySums
...
def _prognostic(
    ...
    from fridom.framework2.grid.fields.vector_field import (  # noqa: PLC0415 — deferred: avoid a field-core import cycle at module load
        VectorField,
    )
