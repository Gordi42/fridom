...
Description
-----------
``fr.transforms.BalanceExpansion`` is the framework2 form of the
...
core (:mod:`fridom.framework2.transforms._slaving`); this module
...
from fridom.framework2.model.eigenstates import resolve_mode_branches
from fridom.framework2.model.energy import EnergyMetric
from fridom.framework2.model.term_predicates import linear, linearize
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from fridom.framework2.transforms._slaving import BalanceResult
