...
cluster's ``f.xr`` export (``fridom.framework2.grid.export``): this
...
class Writer:
    ...
    def _template(self, field: ScalarField, name: str) -> Any:
        ...
        from fridom.framework2.grid.scalars import (  # noqa: PLC0415
            Scalars,
        )
        from fridom.framework2.grid.spaces.coefficient import (  # noqa: PLC0415
            CoefficientSpace,
        )
        ...
        from fridom.framework2.grid.export import (  # noqa: PLC0415
            scalar_to_dataarray,
        )
