...
#         """
#         return self.create_mask_at_position(position)

#     def create_mask_at_position(self, position: fr.grid.Position) -> ndarray:
#         """
#         Create a water mask at the given position.
#         """
#         new_mask = self._domain_decomposition.create_array(pad=True)+1
#         new_mask = self._domain_decomposition.sync(new_mask).astype(bool)
